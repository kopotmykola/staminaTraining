...
[#] 12  -=
222--- 22-2- -22-- 2-2-2 --2-2 20 8-2 2-22- -2-2- 111--- 11-1- -11-- 1-1-1 --1-1 01 1-9 1-11- -1-1- 1-2-3 ===111 ==1=1 1==11 =1=1= 11=1= 1-1=0 2-1=1 =1==1 1=1=1 1 byte = 8 bits 22=2= =22== 2=2=2 ==2=2 52-81=-29 2=22= =2=2= 11212 21122 71 82 12121 22121 --=-= =--== -2-1=-3 -=-=- ==-=- 1-12= -2==1 -1-=2 2-11= 2=21- =1--2 =2=-1 1=22- 7-5=2 Y2K, Blink 182, 911, U-96.mp3
...
[#] # $  ( )
$$$((( $$($( ($$(( $($($ (($($ $84 $0 $($$( ($($( $74 $2.94 $8.49 ###((( ##(#( (##(( #(#(# ((#(# #96 #43 #75 #(##( (#(#( #93 #13 #837 ))#)# #))## )#)#) ##)#) (#9) (#03) )#))# #)#)# (#93) (#3) (#01) $$)$) )$$)) $)$)$ ))$)$ ($04) ($94) $)$$) )$)$) ($74) ($8) ##$#$ $##$$ #73 #$#$# $$#$# $04 (()() )(()) (Yes) ()()( ))()( (A) (B) #(#$) ($))# (#()$ $(##) $)$#( )#(($ )$)(# #)$$(
...
[#] [ ] { }
[[[]]] [[][] ][[]] [][][ ]][][ [C:\Temp\] [][[] ][][] [a,b] [c,d] [3;8] {{{]]] {{]{] ]{{]] {]{]{ ]]{]{ {:-] {]{{] ]{]{] {;-] }}}{{{ }}{}{ {}}{{ {5;4} }{}{} {{}{} {6;2} }{}}{ {}{}{ {3,4} {48,91} [[}[} }[[}} [}[}[ }}[}[ [}[[} }[}[} [1,2} {{[{[ [{{[[ {[{[{ [[{[{ {3,4] ]]}]} }]]}} ]}]}] }}]}] {]{[} ][}}{ ]{]}[ []{{} [}[{] }{]][ }[}]{ {}[[] [C:\Progra~1\] H1 { color:red; }

[#] < >
xxx<<< Xx<x< <xx<< x<x<x <<x<x x<xX< <x<x< zzz<<< Zz<z< <zZ<< z<z<z <<z<z z<zZ< <z<z< >>z>z z>>Zz >z>z> Zz>z> >z>>z z>z>z Xx>x> >xX>> x>x>x >>x>x x>xX> >x>x> <<><> ><<>> <><>< >><>< z<Zx> <x>>z <z<>x x<Zz> <><,. >,..< x>Xz< >z<<x >x><z z>xX< ><>., ,><<.

[#] All symbols
3#3#3 |#|#|# #3 #23 #83 )0)0) :-0 ;) 2@2@2 {@{@{@ user@hotmail.com; 9(9(9 :-9 ;-( 4$4$4 _$_$_$ $4 $1.40 $4.99 7&7&7 &^&^&^ wash & go, black & white 6^6^6 2^8 9^6; 5%5%5 }%}%}% 50% 25% 0%; 8*8*8 *<*<*> *.mp3 6*8=48 1!1!1 !>!>!< OK! Hi! How do you do? 4/2=2 8/2=4 3+2=5 1+3=4 1+2+3+4+5=15 Are you ready? Really? [`[`[` ]~]~]~ \#\#\# _@_@_%_% login@aol.com; `}`}`} #*#*_@_| \~\~{~{ [^[^]^]^ _#_$_%\@ [@_|`\* 5-!=? 9+3-4 _3(3)_ {%&#&@} $]$~_ @&$&*| a>=b>=c ~$\[#&` _@_~\` 1<3<7 5/3 7/4 9/2 %`&~|~ ^@_~}` &$~[|` \`[~*@ F(x)<=F[y]>=F{z}
